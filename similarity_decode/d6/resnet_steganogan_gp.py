...
class SteganoGAN(tf.keras.Model):
  def __init__(self, encoder=None, decoder=None, critic=None, data_depth=6, image_shape=(128, 128, 3), critic_extra_steps=5, gp_weight=10.0):
  ...
  def train_step(self, data):
    ...
    with tf.GradientTape(persistent=True) as encoder_decoder_tape:
      ...
      similarity_loss = self.similarity_loss_fn(cover_images, stego_images) * 100.0
      decoder_loss = self.decoder_loss_fn(messages, recovered_messages) * 100.0
